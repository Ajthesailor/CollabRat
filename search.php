...
<div class="searchContainer">
  ...
  <input type="text" class="searchInput" value="<?php echo $term; ?>" placeholder="Search..." onfocus="var val=this.value; this.value=''; this.value= val;" >
...
<div class="artistsContainer borderBottom">
    ...
    <h2>ARTISTS</h2>
      ...
      if(mysqli_num_rows($artistsQuery) == 0) {
        echo "<span class='noResults'>No artists found matching " . $term . "</spsan>";
      }
